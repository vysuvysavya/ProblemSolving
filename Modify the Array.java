...
class Solution {
    static ArrayList<Integer> modifyAndRearrangeArr(int arr[]) {
        ...
        // Step 2: Collect all non-zero elements first.
        for (int i = 0; i < n; i++) {
            if (arr[i] != 0) {
                result.add(arr[i]);
            }
        ...
        // Step 3: Append zeros to the end.
        while (result.size() < n) {
            result.add(0);
        }
...
So, we will change the element at index 0 to 4 and the element at index 1 is 0 then we will shift all the zeros to the end of the array. So, the array will become [4, 4, 8, 0, 0, 0].
...
Explanation: At index 5 and 6 both the elements are the same. So, we will change the element at index 5 to 12 and the element at index 6 is 0.
  We will change the element at index 1 to 4 and the element at index 2 is 0. Then we shift all the zeros to the end of the array. So, array will become [4, 2, 12, 8, 0, 0, 0, 0, 0, 0].
